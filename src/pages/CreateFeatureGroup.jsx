...
import CreateFeatureGroupForm from '../components/home/form/CreateFeatureGroupForm';

export class CreateFeatureGroupPage extends React.Component {
  constructor(props) {
    super(props);
...
export default CreateFeatureGroupPage;
